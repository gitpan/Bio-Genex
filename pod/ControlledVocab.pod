...
on Thu Dec  7 18:35:48 2000 by /home/jasons/Genex/scripts/create_genex_class.pl --target=ControlledVocab --pkey=term_string --controlled=AL_Coating --controlled=AL_DefaultSpotConcUnits --controlled=AL_TechnologyType --controlled=AL_Medium --controlled=AL_IdentifierCode --controlled=ALS_SpotType --controlled=AM_EquationType --controlled=AM_SpotMeasurementUnits --controlled=AM_Type --controlled=CSF_Type --controlled=ContactType --controlled=EF_MajorCategory --controlled=EF_MinorCategory --controlled=ES_QuantitySeriesType --controlled=ES_TreatmentType --controlled=HS_ThresholdType --controlled=PRT_Type --controlled=SCN_ModelDescription --controlled=SMP_AgeUnits --controlled=SMP_DevelopmentStageName --controlled=SMP_DevelopmentStageUnits --controlled=SMP_GeneticStatus --controlled=SMP_OrganismIntactness --controlled=SMP_OrganType --controlled=SMP_PrimaryCellType --controlled=SMP_SexMatingType --controlled=SMP_TissueType --controlled=SPC_GeneralClassification --controlled=SPC_CellStructure --controlled=SPT_ModelDescription --controlled=SW_Name --controlled=SW_Type --controlled=USF_Type
